...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this.loading = id;
                _context.next = 3;
                return _this.axios.get("/api/get/" + id).then(function (response) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _this2.axios.get("/api/media").then(function (response) {
    ...
    truncateMedia: function truncateMedia(id) {
      var _this3 = this;

      if (confirm("Are you sure you want to truncate media and poster tables?")) {
        this.axios["delete"]("/api/truncate").then(function (response) {
          _this3.getMedias();
        })["catch"](function (error) {
          console.log(error);
        });
...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    ...
    _c(
      ...
      {
        staticClass:
          "col-4 mb-2 flex-column align-items-center justify-content-center"
      },
      [
        _c(
          "button",
          {
            staticClass: "btn btn-primary w-100 mb-4",
            on: {
              click: function($event) {
                return _vm.getMedia(1)
              }
            }
          },
          [
            _vm.loading != 1
              ? _c("span", [_vm._v("Button 1: Sync Matrix")])
              : _vm._e(),
            _vm._v(" "),
            _vm.loading == 1 ? _c("span", [_vm._v("Loading...")]) : _vm._e()
          ]
        ),
        _vm._v(" "),
        _c(
          "button",
          {
            ...
            on: {
              click: function($event) {
                return _vm.getMedia(2)
              }
            }
          },
          [
            _vm.loading != 2
              ? _c("span", [_vm._v("Button 2: Sync Matrix Reloaded")])
              : _vm._e(),
            _vm._v(" "),
            _vm.loading == 2 ? _c("span", [_vm._v("Loading...")]) : _vm._e()
          ]
        ),
        _vm._v(" "),
        _c(
          "button",
          {
            ...
            on: {
              click: function($event) {
                return _vm.getMedia(3)
              }
            }
          },
          [
            _vm.loading != 3
              ? _c("span", [_vm._v("Button 3: Sync Matrix Revolutions")])
              : _vm._e(),
            _vm._v(" "),
            _vm.loading == 3 ? _c("span", [_vm._v("Loading...")]) : _vm._e()
          ]
        ),
        _vm._v(" "),
        _c(
    ...
    _c("div", { staticClass: "col-12" }, [
      _c("div", { staticClass: "card" }, [
        _c("div", { staticClass: "card-header" }, [
          _c("h4", [
            _vm._v("All Media (" + _vm._s(_vm.medias.length) + " records)")
          ])
        ]),
        _vm._v(" "),
                ...
                ? _c(
                    ...
                    _vm._l(_vm.medias, function(media, key) {
                      return _c("tr", { key: key }, [
                        ...
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(media.year))]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(media.imdb_id))]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(media.type))]),
                        _vm._v(" "),
                        _c("td", [
                          media.poster != null
                            ? _c("span", [
